...
settings.divDemo = document.getElementById("viewcontainer");      //div for loading partials
...
miniSPA.gotoView = function(viewName) {          //handle url change
    //var url = viewName;
 
 
    miniSPA.ajaxRequest(viewName, 'GET', '',function(status, page){
        if(status == 404){
	    ...
	    window.history.pushState(state, state.title, url);
            ...
            divDemo = document.getElementById("viewcontainer"); 
